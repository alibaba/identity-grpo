...
class Qwen2_5_VLRewardModelBT(Qwen2_5_VLForConditionalGeneration):
    def __init__(self, config, output_dim=3, reward_token="last", special_token_ids=None):
    ...
    def forward(
        ...
        ## modified from the origin class Qwen2_5_VLForConditionalGeneration
